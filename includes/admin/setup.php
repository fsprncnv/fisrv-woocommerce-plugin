...
namespace FiservWoocommercePlugin\Admin;

/**
 * FiservWoocommercePlugin Setup Class
 */
class Setup {
	/**
	 * Constructor.
	...
	public function register_scripts() {
		...
		wp_enqueue_script( 'fiserv-woocommerce-plugin' );
		wp_enqueue_style( 'fiserv-woocommerce-plugin' );
	}
	...
	public function register_page() {
		...
		wc_admin_register_page(
			array(
				'id'     => 'fiserv_woocommerce_plugin-example-page',
				'title'  => __( 'Fiserv Woocommerce Plugin', 'fiserv_woocommerce_plugin' ),
				'parent' => 'woocommerce',
